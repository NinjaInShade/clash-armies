...
export type Modal<C extends AnyComponent = AnyComponent> = {
...
export type AppState = {
	...
	// Modals
	modals: Modal[];
	openModal<T = unknown, C extends AnyComponent = AnyComponent>(
		component: C,
		props?: Omit<ComponentProps<C>, keyof ModalAddons>,
		onClose?: (rtnValue?: T) => void
	): void;
	openModalAsync<T = unknown, C extends AnyComponent = AnyComponent>(component: C, props?: Omit<ComponentProps<C>, keyof ModalAddons>): Promise<T | undefined>;
	// Notifications
