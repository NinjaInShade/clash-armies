...
export async function v0_1_0_data_migrate(db: MySQL) {
    // Add cc capacity data fields to town halls table
    await db.query(`
    ...
    `);
    // Update cc capacity for each town hall
    const ccData = [
        { maxCc: null, troops: 0, spells: 0, sieges: 0, labCap: 0 },
        { maxCc: 1, troops: 10, spells: 0, sieges: 0, labCap: 5 },
        { maxCc: 1, troops: 10, spells: 0, sieges: 0, labCap: 5 },
        { maxCc: 2, troops: 15, spells: 0, sieges: 0, labCap: 6 },
        { maxCc: 2, troops: 15, spells: 0, sieges: 0, labCap: 6 },
        { maxCc: 3, troops: 20, spells: 0, sieges: 0, labCap: 7 },
        { maxCc: 3, troops: 20, spells: 0, sieges: 0, labCap: 7 },
        { maxCc: 4, troops: 25, spells: 1, sieges: 0, labCap: 8 },
        { maxCc: 5, troops: 30, spells: 1, sieges: 0, labCap: 9 },
        { maxCc: 6, troops: 35, spells: 1, sieges: 1, labCap: 10 },
        { maxCc: 7, troops: 35, spells: 2, sieges: 1, labCap: 11 },
        { maxCc: 8, troops: 40, spells: 2, sieges: 1, labCap: 12 },
        { maxCc: 9, troops: 45, spells: 2, sieges: 1, labCap: 13 },
        { maxCc: 10, troops: 45, spells: 3, sieges: 1, labCap: 14 },
        { maxCc: 11, troops: 50, spells: 3, sieges: 1, labCap: 14 },
        { maxCc: 12, troops: 50, spells: 3, sieges: 2, labCap: 14 },
    ]
    ...
    // Update army units table to include a field to tell where this unit is housed in (army camp or clan castle)
    await db.query(`
