	...
	<div class="controls">
		<div class="controls-group">
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+I"
				aria-label="{italicActive ? 'Disable' : 'Enable'} italic text"
			>
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+Shift+S"
				aria-label="{strikeActive ? 'Disable' : 'Enable'} strikethrough text"
			>
		...
		<div class="controls-group">
			<button
				...
				class="focus-grey"
				title="Ctrl+Alt+1"
				aria-label="{h1Active ? 'Disable' : 'Enable'} heading 1 text"
			>
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+Alt+2"
				aria-label="{h2Active ? 'Disable' : 'Enable'} heading 2 text"
			>
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+Alt+3"
				aria-label="{h3Active ? 'Disable' : 'Enable'} heading 3 text"
			>
				<svg width="15" height="9" viewBox="0 0 15 9" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
		...
		<div class="controls-group">
			<button
				...
				class="focus-grey"
				title="Ctrl+Shift+L"
				aria-label="{alignLeftActive ? 'Disable' : 'Enable'} left aligned text"
			>
				<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+Shift+E"
				aria-label="{alignCenterActive ? 'Disable' : 'Enable'} center aligned text"
			>
				<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+Shift+R"
				aria-label="{alignRightActive ? 'Disable' : 'Enable'} right aligned text"
			>
				<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
		...
		<div class="controls-group">
			<button
				...
				class="focus-grey"
				title="Ctrl+Shift+8"
				aria-label="{bulletListActive ? 'Remove' : 'Add'} bullet list"
			>
			...
			<button
				...
				class="focus-grey"
				title="Ctrl+Shift+7"
				aria-label="{orderedListActive ? 'Remove' : 'Add'} numbered list"
			>
			...
			<button onclick={addHr} class="focus-grey" aria-label="Add horizontal rule">
		...
		<div class="separator"></div>
		<div class="controls-group">
			<button onclick={toggleLinkMenu} class="focus-grey" title="Ctrl+K" bind:this={linkRef} aria-label="Add link">
			...
			<button onclick={unsetLink} class="focus-grey" title="Ctrl+Shift+K" disabled={!linkActive} aria-label="Remove link">
		...
		<div class="separator"></div>
		<div class="controls-group">
			<button onclick={undo} class="focus-grey" title="Ctrl+Z" disabled={!canUndo} aria-label="Undo">
				<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
			...
			<button onclick={redo} class="focus-grey" title="Ctrl+Y" disabled={!canRedo} aria-label="Redo">
				<svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
