...
{#snippet filterBtn(text: string, isActive: boolean, onclick: Function)}
	<C.ActionButton theme={isActive ? 'primary-dark' : 'grey'} class={isActive ? 'focus-primary' : 'focus-grey'} {onclick}>
		{text}
	</C.ActionButton>
{/snippet}
			...
			<li>
				...
				>
					{#if unit.pickType === 'unit'}
						<C.UnitDisplay {...unit} title={picker ? title : undefined} />
					{:else if unit.pickType === 'equipment'}
						<C.EquipmentDisplay {...unit} title={picker ? title : undefined} />
					{:else}
						<C.PetDisplay {...unit} title={picker ? title : undefined} />
					{/if}
				</button>
			</li>
		{/each}
...
<C.FocusTrap>
	<div class="filters-popup">
		...
		<div class="controls">
			<C.ActionButton theme="danger" onclick={resetFilters}>
			...
			<div class="controls-flex">
				<C.ActionButton theme="primary-dark" onclick={() => close()}>Cancel</C.ActionButton>
				<C.ActionButton theme="primary-dark" onclick={() => close(filters)}>Apply</C.ActionButton>
			</div>
		</div>
	</div>
</C.FocusTrap>
